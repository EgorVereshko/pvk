...
//     // Слушаем событие обновления из Models
//     const handleStorageChange = (e) => {
//       if (e.key === 'update_student_scores') {
//         console.log('Обнаружено обновление модели, пересчитываем оценки');
//         updateStudentsWithRandomScores();
//       }
//     };
...
//   // Функция для генерации рандомного среднего балла
//   const generateRandomScore = () => {
//     // Генерируем число от -1 до 3 с одним десятичным знаком
//     const min = -1;
//     const max = 3;
...
//   // Функция для обновления студентов с рандомными оценками
//   const updateStudentsWithRandomScores = () => {
//     setStudents(prevStudents => 
//       prevStudents.map(student => ({
//         ...student,
//         averageScore: generateRandomScore()
//       }))
//     );
//     console.log('Оценки студентов обновлены на рандомные');
//   };

//   const fetchAverageScore = async (userId) => {
//     // Проверяем флаг обновления
//     const needUpdate = localStorage.getItem('update_student_scores');
//     if (needUpdate) {
//       localStorage.removeItem('update_student_scores');
//       // Возвращаем рандомную оценку вместо запроса к API
...
//         }
//       }
//       return generateRandomScore(); // Если нет оценок, тоже генерируем рандом
//     } catch (err) {
//       console.error(`Ошибка получения оценок для пользователя ${userId}:`, err);
//       return generateRandomScore();
//     }
...
//                 averageScore = generateRandomScore();
//               } else {
//                 averageScore = await fetchAverageScore(student.user_id);
//               }
